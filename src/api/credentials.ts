...
const scope =
  'user-read-private user-read-email user-library-read user-top-read streaming user-follow-read user-follow-modify playlist-read-collaborative playlist-read-private'
